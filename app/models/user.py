...
class User(Base):
    ...
    mission_comments = relationship("MissionComment", back_populates="author")
    mission_attachments = relationship("MissionAttachment", back_populates="author")
    ...
    discovered_vulnerabilities = relationship("Vulnerability", foreign_keys="[Vulnerability.discovered_by]", back_populates="discoverer")
    fixed_vulnerabilities = relationship("Vulnerability", foreign_keys="[Vulnerability.fixed_by]", back_populates="fixer")